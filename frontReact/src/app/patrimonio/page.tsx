              ...
              <form id="patrimonioForm" onSubmit={cadastrarPatrimonio}>
                <div className="form-group justify-center flex flex-col">
                  ...
                  <input
                    ...
                    id="nome_patrimonio"
                    name="nome_patrimonio" // Adicione o atributo name com o mesmo nome do campo correspondente no estado
                    value={patrimonioFormData.nome_patrimonio} // Associe o valor ao estado
                    onChange={handleChange} // Adicione um manipulador de eventos para atualizar o estado quando o campo mudar
                    required
                  />
